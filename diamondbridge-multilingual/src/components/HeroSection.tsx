        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mt-20">
            <div className="text-center">
              ...
              <div className="text-gray-700">{t('home.stats.profitToAuthor')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-green-600 mb-2">100%</div>
              <div className="text-gray-700">{t('home.stats.authorshipProtection')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600 mb-2">30%</div>
              <div className="text-gray-700">{t('home.stats.developmentFund')}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-600 mb-2">∞</div>
              <div className="text-gray-700">{t('home.stats.globalNetwork')}</div>
            </div>
          </div>
        </div>
      </div>
